 ...
 * Usage:
 *
 * $Tax_Control = new Taxonomy_Single_Term( 'custom-tax-slug', array( 'post_type' ), 'type' ); // 'type' can be 'radio' or 'select' (default: radio)
 *
 * Update optional properties:
 *
 * $Tax_Control->set( 'priority', 'low' );
 * $Tax_Control->set( 'context', 'normal' );
 * $Tax_Control->set( 'metabox_title', __( 'Custom Metabox Title', 'yourtheme' ) );
 * $Tax_Control->set( 'force_selection', true );
 * $Tax_Control->set( 'indented', false );
 * $Tax_Control->set( 'allow_new_terms', true );
 *
...
class Class_Taxonomy_Single_Term
{
...
<?php
			...
			public function walker()
			{
				...
				require_once('class-walker-taxonomy-single-term' . '.php');
				$this->walker = new Class_Taxonomy_Single_Term_Walker($this->taxonomy()->hierarchical, $this->input_element);
