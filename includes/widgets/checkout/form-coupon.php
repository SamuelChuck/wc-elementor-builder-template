...
class Widget_Checkout_Coupon_Form_Widget extends Widget_Base
{
...
Plugin::elementor_instance()->widgets_manager->register_widget_type(new Widget_Checkout_Coupon_Form_Widget());
